#!/usr/bin/env python
# Author: Ryan Brown
# Description: What is the greatest product of four adjacent numbers in any direction (up, down, left, right, or diagonally) in the 20x20 grid?
import itertools
grid = [
...
wombocombo = list(itertools.permutations(range(20), 2))
